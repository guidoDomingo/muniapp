        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                    ...
                    <div class="nav-logo">
                        <div class="nav-item theme-logo">
                            <a href="{{ route('solicitudes.index') }}">
                                <img src="{{ asset('src/assets/img/caacupe.png') }}" style="border-radius: 50%;" alt="logo">
                            </a>
                        </div>
                        <div class="nav-item theme-text">
                            <a href="{{ route('solicitudes.index') }}" class="nav-link"> APP </a>
                        </div>
                    </div>
                    <div class="nav-item sidebar-toggle">
                        <div class="btn-toggle sidebarCollapse">
                            {{-- <img src="{{ asset('src/assets/img/caacupe.png') }}" width="50px" height="50px" class="" alt="logo"> --}}
                        </div>
                    </div>
                </div>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a href="{{ route('tramites.index') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ route('chatbot.index') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    @if(Auth::user()->hasRole('admin'))
                    <li class="menu">
                        <a href="{{ route('chatbot.admin') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
